<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate_n.master" AutoEventWireup="true"
    CodeFile="SendSMS.aspx.cs" Inherits="Logged_Pages_AParents_Reports_SendSMS" Title="SMS_Center" %>
                                    ...
                                    <asp:TabContainer ID="TabCon1" runat="server" ActiveTabIndex="4" Width="927px" 
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <div class="sms_Row_field">
                                                    <div class="fieldsElementCell">
                                                        <asp:Label ID="Label1" runat="server" Text="Parents Count :"></asp:Label>
                                                    </div>
                                                    <div class="fieldsElementCell">
                                                        <asp:TextBox ID="txtSchlCount" runat="server" Height="20px" Width="190px" 
                                                            ValidationGroup="sendSMSAll" ReadOnly="True"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <br>
                                                        ...
                                                        <div class="sms_Row_field">
                                                            ...
                                                            <div class="sms_Row_field">
                                                                ...
                                                                <asp:Label ID="lblAllStatu" runat="server" Font-Size="12px" ForeColor="#00CC00" Text="Sending..."
                                                                    Visible="False"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <br>
                                                    <asp:GridView ID="gridAll" runat="server" Width="159px">
                                                    </asp:GridView>
                                                    <br>
                                                    <br></br>
                                                    <br>
                                                ...
                                                <div class="sms_Row_field">
                                                    ...
                                                    <div class="fieldsElementCell">
                                                        <asp:DropDownList ID="DrpDwnGrade" runat="server" Width="180px" ToolTip="Choose a Grade"
                                                            AutoPostBack="True" OnSelectedIndexChanged="DrpDwnGrade_SelectedIndexChanged1">
                                                    ...
                                                    <br>
                                                        ...
                                                        <div class="sms_Row_field">
                                                            <div class="fieldsElementCell">
                                                                <asp:Label ID="Label20" runat="server" Text="Parents Count :"></asp:Label>
                                                            </div>
                                                            <div class="fieldsElementCell">
                                                                ...
                                                                <div class="sms_Row_field">
                                                                    ...
                                                                    <div class="fieldsCaptionCell">
                                                                        <asp:Button ID="btnGardeRst" runat="server" CssClass="buttonText" Height="21px" OnClick="btnGardeRst_Click"
                                                                            Text="Reset" ToolTip="To clear the Fields" Width="90px" />
                                                                    </div>
                                                                    <div class="fieldsCaptionCell">
                                        ...
                                        <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="Notify Parents of a Class">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <div class="sms_Row_field">
                                                    ...
                                                    <div class="fieldsElementCell">
                                                        <asp:DropDownList ID="DrpDwnClassClass" runat="server" Width="180px" ToolTip="Choose a Class"
                                                            AutoPostBack="True" Visible="False" OnSelectedIndexChanged="DrpDwnClassClass_SelectedIndexChanged">
                                                ...
                                                <div class="sms_Row_field">
                                                    <div class="fieldsElementCell">
                                                        <asp:Label ID="Label25" runat="server" Text="Parents Count :"></asp:Label>
                                                    </div>
                                                    <div class="fieldsElementCell">
                                                        <asp:TextBox ID="txtCnt_Class" runat="server" Width="187px" 
                                                            ValidationGroup="sendSMSClass" ReadOnly="True"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="sms_Row_field">
                                                        ...
                                                        <div class="fieldsElementCell">
                                                            <asp:TextBox ID="txt_Class_sender" runat="server" 
                                                                ValidationGroup="sendSMSClass" Width="193px"></asp:TextBox>
                                                        </div>
                                                        ...
                                                        <div class="sms_Row_field">
                                                            ...
                                                            <div class="fieldsCaptionCell">
                                                                <asp:Button ID="btnClassRst" runat="server" CssClass="buttonText" Height="21px" 
                                                                    OnClick="btnClassRst_Click" Text="Reset" ToolTip="To clear the Fields" 
                                                                    ValidationGroup=" " Width="69px" />
                                                            </div>
                                                            <div class="fieldsCaptionCell">
                                                                <asp:Button ID="btnClassSend" runat="server" CssClass="buttonText" 
                                                                    Height="21px" OnClick="btnClassSend_Click" Text="Send" 
                                                                    ToolTip="Click to send SMS" ValidationGroup="sendSMSClass" Width="90px" />
                                                            </div>
                                                        ...
                                                        <br />
                                                        <asp:GridView ID="gridClasses" runat="server">
                                                        </asp:GridView>
                                                    </div>
                                                </div>
                                            </ContentTemplate>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <div class="sms_Row_field">
                                                    ...
                                                    <asp:DropDownList ID="DrpDwnGroupStd" runat="server" Width="180px" ToolTip="Choose a Student name"
                                                        Visible="False" AutoPostBack="True" OnSelectedIndexChanged="DrpDwnGroupStd_SelectedIndexChanged">
                                                        <asp:ListItem>Shyamike</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <br>
                                                </div>
                                                ...
                                                <div class="sms_Row_field">
                                                    ...
                                                    <asp:Button ID="BtnAddGrp" runat="server" Height="21px" Text="Add " Width="90px"
                                                        CssClass="buttonText" ToolTip="Click to ADD the student" OnClick="BtnAddGrp_Click" />
