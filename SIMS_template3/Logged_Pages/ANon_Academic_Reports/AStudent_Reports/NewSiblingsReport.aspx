<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate_n.master" AutoEventWireup="true"
    CodeFile="NewSiblingsReport.aspx.cs" Inherits="Logged_Pages_AParents_Reports_Parent_Info"
                    ...
                    <div class="FormRow">
                        ...
                        <div class="fieldsElementCell">
                           <asp:DropDownList class="RTxt" ID="ddlGrade" runat="server" Height="20px" Width="180px"
                                    AutoPostBack="true" 
                                OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" CssClass="FormTxtBox">
                        ...
                        <div class="fieldsCaptionCell">
                          <asp:Label class="RLable" runat="server" Text="Class :" Visible ="False"  ID="lblClass" ></asp:Label>
                        </div>
                        <div class="fieldsElementCell">
                            <asp:DropDownList class="RTxt" ID="ddlClass" runat="server" Height="20px" Width="180px"
                                    OnSelectedIndexChanged="ddlClass_SelectedIndexChanged" 
                                Visible = "False" AutoPostBack="true" CssClass="FormTxtBox">
                                </asp:DropDownList>
                        </div>       
                        
                        <div class="fieldsCaptionCell">
                            <asp:Label class="RLable" runat="server" Visible = "False" Text="Student :" ID="lblStudent"></asp:Label>
                        </div>
                        <div class="fieldsElementCell">
                           <asp:DropDownList class="RTxt" ID="ddlStudent" runat="server" Visible = "False" 
                                Height="20px" Width="180px"
                                    OnSelectedIndexChanged="ddlStudent_SelectedIndexChanged" 
                                AutoPostBack="true" CssClass="FormTxtBox">
                                </asp:DropDownList>
                        </div>            
