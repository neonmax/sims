<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate_n.master" AutoEventWireup="true"
    CodeFile="Sent_Notification_Report.aspx.cs" Inherits="Logged_Pages_AParents_Reports_Parent_Info"
            ...
            <ContentTemplate>
                <div class="ReportBody">
                    ...
                    <div class="ReportDesc">
                        History of Notifications sent to Parents<asp:Label ID="lbl" runat="server" 
                            Text=""></asp:Label>
                    </div>
                </div>
                ...
                <div class="FormBackgroundAddAppointment">
                    ...
                    <div class="FormRow">
                        ...
                        <div class="fieldsElementCell">
                            <asp:TextBox ID="txtStart" runat="server" Width="165px" CssClass="FormTxtBox "></asp:TextBox>
                            <img id="img1" src="../../images/Calendar_scheduleHS.png" alt="Picture" border="0" onclick="popupCalender()">
                        </div>
                         <div class="fieldsCaptionCell"></div>
                        <div class="fieldsCaptionCell">
                            <asp:Label ID="Label11" runat="server" class="RLable" Text="End Date :"></asp:Label>
                        </div>
                        <div class="fieldsElementCell">
                           <asp:TextBox ID="txtEnd" runat="server" Width="165px" CssClass="FormTxtBox " 
