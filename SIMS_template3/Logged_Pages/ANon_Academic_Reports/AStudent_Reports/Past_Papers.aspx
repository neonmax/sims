<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate_n.master" AutoEventWireup="true"
    CodeFile="Past_Papers.aspx.cs" Inherits="Logged_Pages_AParents_Reports_Parent_Info"
    ...
    <div id="wrap">
            ...
            <ContentTemplate>
                <div class="ReportBody">
                    ...
                    <div class="ReportDesc">
                        Download the Examination Pastpapers
                    </div>
                </div>
        ...
        <div class="FormBackgroundAddAppointment">
            <asp:GridView ID="GridViewPastPapers" runat="server" AutoGenerateColumns="False"
                ...
                Width="97%" AllowPaging="True" CssClass="grid-view" AllowSorting="True">
                <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSourcePastPapers" runat="server" ConnectionString="<%$ ConnectionStrings:nsis %>"
            ProviderName="<%$ ConnectionStrings:nsis.ProviderName %>" SelectCommand="SELECT  P.PPRID, P.YEAR, P.GRADE, P.TERM, P.FILENAME, P.SIZE, S.SUBJECT FROM subjects_mast S, past_papers P WHERE P.SUB_CODE = S.SUBJECT_CODE">
        </asp:SqlDataSource>
        <%--      </ContentTemplate>
        </asp:UpdatePanel>--%>
