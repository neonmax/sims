<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate.master" AutoEventWireup="true"
    CodeFile="GeneralPerformance.aspx.cs" Inherits="Logged_Pages_AParents_Reports_Parent_Info"
                ...
                <div class="ReportBody">
                    ...
                    <div class="RepOptionsFixed40">
                        ...
                        <div class="RepOptInstance">
                            ...
                            <div class="RepTxt">
                                <asp:DropDownList class="RTxt" ID="ddlStudent" runat="server" Height="20px" Width="180px"
