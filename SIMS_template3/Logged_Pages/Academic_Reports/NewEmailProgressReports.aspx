<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate_n.master" AutoEventWireup="true"
    CodeFile="NewEmailProgressReports.aspx.cs" Inherits="Logged_Pages_AParents_Reports_Parent_Info"
    ...
    <asp:UpdatePanel ID="HmUpPnl" runat="server">
            <ContentTemplate>
                ...
                <div class="FormBackgroundAddAppointment">
                    ...
                    <div class="FormRow">
                        ...
                        <div class="fieldsCaptionCell">
                            <asp:Label ID="Label2" runat="server" class="RLable" Text="Year :"></asp:Label>
                        </div>
                        <div class="fieldsElementCell">
                            <asp:DropDownList class="RTxt" ID="ddlYear" runat="server" Height="20px" CssClass="FormTxtBox "
                                Width="185px" AutoPostBack="true">
                                <asp:ListItem Value="this">This Year</asp:ListItem>
                                <asp:ListItem Value="last">Last Year </asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="fieldsCaptionCell">
                            <asp:Label runat="server" class="RLable" Text="Term :"></asp:Label>
                        </div>
                        <div class="fieldsElementCell">
                            <asp:DropDownList class="RTxt" ID="ddlTerm" runat="server" Height="20px" CssClass="FormTxtBox "
                                Width="185px" AutoPostBack="true">
                                <asp:ListItem Value="empty">Select Term</asp:ListItem>
                                <asp:ListItem Value="1">1st Term </asp:ListItem>
                                <asp:ListItem Value="2">2nd Term </asp:ListItem>
                                <asp:ListItem Value="3">3rd Term </asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="paraSpace">
                    ...
                    <div class="FormRow">
                        ...
                        <div class="fieldsElementCell">
                            <asp:TextBox ID="txtSubject" runat="server" Width="669px" CssClass="FormTxtBox "></asp:TextBox>
                        </div>
                    </div>
                    <div class="paraSpace">
                    </div>
                    ...
                    <div class="field_3_Row162app">
                        ...
                        <asp:TextBox ID="txtMessage" Class="FormTxtBox " runat="server" Height="160px" TextMode="MultiLine"
        ...
        <div class="FormFooter">
            <CR:CrystalReportViewer ID="crvReportViewer" runat="server" AutoDataBind="true" DisplayGroupTree="False"
                EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" Visible="False" />
