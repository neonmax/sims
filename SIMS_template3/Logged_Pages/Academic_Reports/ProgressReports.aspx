<%@ Page Language="C#" MasterPageFile="~/Logged_Pages/ReportTemplate.master" AutoEventWireup="true"
    CodeFile="ProgressReports.aspx.cs" Inherits="Logged_Pages_AParents_Reports_Parent_Info"
                ...
                <div class="ReportBody">
                    ...
                    <div class="RepOptionsFixed">
                        ...
                        <div class="RepOptInstance">
                            ...
                            <div class="RepTxt">
                                <asp:DropDownList class="RTxt" ID="ddlClass" runat="server" Height="20px" Width="185px"
                        ...
                        <div class="RepOptInstance">
                            <div class="RepLbl">
                                <asp:Label class="RLable" runat="server" Text="Student :"></asp:Label>
                            </div>
                            <div class="RepTxt">
                                <asp:DropDownList class="RTxt" ID="ddlStudentName" runat="server" Height="20px" Width="185px"
                        ...
                        <div class="RepOptInstance">
                            <div class="RepLbl">
                                <asp:Label class="RLable" runat="server" Text="Term :"></asp:Label>
                            </div>
                            <div class="RepTxt">
                                <asp:DropDownList ID="ddlTerm" runat="server" Height="20px" Width="185px" OnSelectedIndexChanged="ddlTerm_SelectedIndexChanged"
                                    AutoPostBack="true">
